...
//        }
    ...
    fun updateWeather(weatherItemList: ArrayList<*>){
        ...
        high_low_temperature_tv.text = String.format(getString(R.string.min_max_temperature), weatherItem.tempmax, weatherItem.tempmin)
        ...
        wind_tv.text = String.format(getString(R.string.wind_speed), weatherItem.wind.toInt().toString())
        humidity_tv.text = String.format(getString(R.string.humidity), weatherItem.humidity.toString())
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        cityname?.let {
            if (latitude != null) {
                if (longitude != null) {
                    val newdata = Intent(MainActivity.SEND_UPDATE_REQUEST).apply {
                        setting.cityName = it
                        setting.latitude = latitude
                        setting.longitude = longitude
